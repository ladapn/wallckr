...
void test_assert_equal(float expected, float actual) {
  // TEST_ASSERT_EQUAL_FLOAT computes delta (epsilon) on the fly: expected *
  // 0.00001
  TEST_ASSERT_EQUAL_FLOAT(expected, actual);
}

template <int N, typename T>
void test_step(const T input[], const T expected[], unsigned len) {
  ExpFilter<T, N> filter;
...
void test_step_N_4_int(void) {
  ...
  const int input[] = {0,   0,   0,   0,   100, 100, 100, 100, 100, 100,
                       100, 100, 100, 100, 100, 100, 100, 100, 100};
  const int expected[] = {0,  0,  0,  0,  25, 43, 57, 67, 75, 81,
                          85, 88, 91, 93, 94, 95, 96, 97, 97};
...
void test_step_N_4_float(void) {
  constexpr int FILTER_N = 4;
  const float input[] = {0,   0,   0,   0,   100, 100, 100, 100, 100, 100,
                         100, 100, 100, 100, 100, 100, 100, 100, 100};
...
void test_step_N_10_int(void) {
  constexpr int FILTER_N = 10;
  const int input[] = {0,   0,   0,   0,   100, 100, 100, 100, 100, 100,
                       100, 100, 100, 100, 100, 100, 100, 100, 100};
  const int expected[] = {0,  0,  0,  0,  10, 19, 27, 34, 40, 46,
                          51, 55, 59, 63, 66, 69, 72, 74, 76};
